...
class OndiskAttendanceChecker(BaseAttendanceChecker):
    """
    온디스크 (OnDisk) 복불복 출석체크 룰렛 자동화 클래스
    - 로그인 URL: https://ondisk.co.kr/index.php
    - 출석체크 URL: https://ondisk.co.kr/main/eventMarge.php?mode=eventMarge&sm=event&action=view&idx=171
    """
    ...
    def check_attendance(self, page: Page, site_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        attend_url = site_info.get(
            "url",
            "https://ondisk.co.kr/main/eventMarge.php?mode=eventMarge&sm=event&action=view&idx=171"
        )
